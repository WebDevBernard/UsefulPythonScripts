...
target_dict = {
    "Aviva":
        FormFields(
            ...
            risk_address=TargetFields(target_keyword="FORM", first_index=-1, second_index=remaining_index,
                                      join_list=True),
    ...
    "Intact":
        FormFields(
            ...
            condo_earthquake_deductible=TargetFields(target_keyword="Additional Loss Assessment", first_index=0,
                                                     second_index=0),
    ...
    "Wawanesa":
        FormFields(
            ...
            risk_address=TargetFields(target_keyword="Location Description", first_index=1, second_index=1,
                                      append_duplicates=True),
            form_type=TargetFields(target_keyword="subject to all conditions of the policy.", first_index=3,
                                   second_index=0, append_duplicates=True),
