from helper_funtions import base_dir, emoji, unique_file_name, write_text_coords
...
if __name__ == "__main__":
    ...
    for pdf_file in pdf_file_paths:
        ...
        write_text_coords(pdf_file, block_dict, table_dict, word_dict)  # dicts falsey = off
